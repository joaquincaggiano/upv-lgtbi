...
const GopuScreenTemplate = props => {
  const {
    goBack,
    openLink,
  } = props;
  ...
  return (
    <Layout
      onPressBack={goBack}
      title={I18n.t('gopuTitle')}>
      <Text style={[styles.text, styles.fontSizeSmall, styles.textColorGray, {lineHeight: 23}]}>{I18n.t('gopuText')}</Text>
...
export default GopuScreenTemplate;
