    ...
    <Layout header={false}>
      ...
      {showLangSelector && (
        <View
          style={[
            styles.box,
            {position: 'absolute', right: paddingScreens, top: 60, paddingHorizontal: 12, paddingVertical: 8, zIndex: 100},
          ]}>
          {lang !== 'ca' && (
            <TouchableOpacity
              onPress={changeLanguageHandler.bind(undefined, 'ca')}
              style={{justifyContent: 'center', alignItems: 'center', paddingVertical: 4}}>
              <Text style={[styles.text, styles.fontSizeSmall, styles.fontWeightSemiBold]}>VAL</Text>
            </TouchableOpacity>
          )}
          {lang !== 'es' && (
            <TouchableOpacity
              ...
              style={{justifyContent: 'center', alignItems: 'center', paddingVertical: 4}}>
              <Text style={[styles.text, styles.fontSizeSmall, styles.fontWeightSemiBold]}>CAS</Text>
            </TouchableOpacity>
          )}
          {lang !== 'en' && (
            <TouchableOpacity
              ...
              style={{justifyContent: 'center', alignItems: 'center', paddingVertical: 4}}>
              <Text style={[styles.text, styles.fontSizeSmall, styles.fontWeightSemiBold]}>ENG</Text>
            </TouchableOpacity>
          )}
        </View>
      )}
